...
NativeUserInformation::NativeUserInformation() noexcept
{
    ...
    home_path_ = NativePathHelpers::get_home_wpath();
    local_path_ = NativePathHelpers::get_local_appdata_wpath();
    roaming_path_ = NativePathHelpers::get_roaming_appdata_wpath();
}
